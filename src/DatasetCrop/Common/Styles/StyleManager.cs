...
public class StyleManager
{
    ...
    private readonly StyleInclude darkStyle = CreateStyle("avares://DatasetCrop/Common/Styles/Dark.xaml");
    private readonly StyleInclude lightStyle = CreateStyle("avares://DatasetCrop/Common/Styles/Light.xaml");
    #endregion
    ...
    {
        return new StyleInclude(new Uri("resm:Styles?assembly=DatasetCrop"))
        {
            Source = new Uri(url)
        };
    }
